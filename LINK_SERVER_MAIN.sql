...
/****** Object:  LinkedServer [LINK]    Script Date: 6/12/2019 1:56:24 AM ******/
EXEC master.dbo.sp_addlinkedserver @server = N'LINK', @srvproduct=N'', @provider=N'SQLNCLI', @datasrc=N'DESKTOP-4AOI1UG'
...
EXEC master.dbo.sp_serveroption @server=N'LINK', @optname=N'rpc', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'LINK', @optname=N'rpc out', @optvalue=N'false'
GO
