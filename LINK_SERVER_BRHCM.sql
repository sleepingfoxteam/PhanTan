...
/****** Object:  LinkedServer [LINK]    Script Date: 6/12/2019 1:56:09 AM ******/
EXEC master.dbo.sp_addlinkedserver @server = N'LINK', @srvproduct=N'', @provider=N'SQLNCLI', @datasrc=N'DESKTOP-4AOI1UG\CN2'
